...
for i = 1 : numel(file_list)
	...
	train_data{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
for i = 1 : numel(file_list)
    disp(file_list{i});
	[wave,fs]=audioread(file_list{i});
    dev_data{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('train_data.mat','train_data','train_label','train_y');
save('dev_data.mat','dev_data','dev_label','dev_y');
...
for i = 1 : numel(file_list)
    disp(file_list{i});
    [wave,fs]=audioread(file_list{i});
    test_data{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('test_data.mat','test_data','test_label','test_y');
...
for i = 1 : numel(file_list)
	disp(file_list{i});
	[wave,fs]=audioread(file_list{i});
	train_data_mix0{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
for i = 1 : numel(file_list)
    disp(file_list{i});
	[wave,fs]=audioread(file_list{i});
    dev_data_mix0{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('train_data_mix0.mat','train_data_mix0','train_label_mix0','train_y_mix0');
save('dev_data_mix0.mat','dev_data_mix0','dev_label_mix0','dev_y_mix0');
...
for i = 1 : numel(file_list)
    disp(file_list{i});
    [wave,fs]=audioread(file_list{i});
    test_data_mix0{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('test_data_mix0.mat','test_data_mix0','test_label_mix0','test_y_mix0');
...
% comment our for paralell loop
%parfor i = 1 : numel(file_list)
for i = 1 : numel(file_list)
	disp(file_list{i});
	[wave,fs]=audioread(file_list{i});
	train_data_mix10{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
for i = 1 : numel(file_list)
    disp(file_list{i});
	[wave,fs]=audioread(file_list{i});
    dev_data_mix10{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('train_data_mix10.mat','train_data_mix10','train_label_mix10','train_y_mix10');
save('dev_data_mix10.mat','dev_data_mix10','dev_label_mix10','dev_y_mix10');
...
for i = 1 : numel(file_list)
    disp(file_list{i});
    [wave,fs]=audioread(file_list{i});
    test_data_mix10{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('test_data_mix10.mat','test_data_mix10','test_label_mix10','test_y_mix10');
...
for i = 1 : numel(file_list)
	disp(file_list{i});
	[wave,fs]=audioread(file_list{i});
	train_data_mix20{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
for i = 1 : numel(file_list)
    disp(file_list{i});
	[wave,fs]=audioread(file_list{i});
    dev_data_mix20{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('train_data_mix20.mat','train_data_mix20','train_label_mix20','train_y_mix20');
save('dev_data_mix20.mat','dev_data_mix20','dev_label_mix20','dev_y_mix20');
...
for i = 1 : numel(file_list)
    disp(file_list{i});
    [wave,fs]=audioread(file_list{i});
    test_data_mix20{i} = SIF(wave,fs,ny,winlen,overlap);
end
...
save('test_data_mix20.mat','test_data_mix20','test_label_mix20','test_y_mix20');