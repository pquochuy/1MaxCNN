...
load('dev_data.mat');
load('test_data.mat');
load('train_data_mix0.mat');
load('dev_data_mix0.mat');
load('test_data_mix0.mat');
load('train_data_mix10.mat');
load('dev_data_mix10.mat');
load('test_data_mix10.mat');
load('train_data_mix20.mat');
load('dev_data_mix20.mat');
load('test_data_mix20.mat');
...
save('train_data_tensorflow.mat','train_data','train_label','train_y');
...
save('dev_data_tensorflow.mat','dev_data','dev_label','dev_y');
...
save('test_data_tensorflow.mat','test_data','test_label','test_y');
...
save('train_data_mix0_tensorflow.mat','train_data_mix0','train_label_mix0','train_y_mix0');
...
save('dev_data_mix0_tensorflow.mat','dev_data_mix0','dev_label_mix0','dev_y_mix0');
...
save('test_data_mix0_tensorflow.mat','test_data_mix0','test_label_mix0','test_y_mix0');
...
save('train_data_mix10_tensorflow.mat','train_data_mix10','train_label_mix10','train_y_mix10');
...
save('dev_data_mix10_tensorflow.mat','dev_data_mix10','dev_label_mix10','dev_y_mix10');
...
save('test_data_mix10_tensorflow.mat','test_data_mix10','test_label_mix10','test_y_mix10');
...
save('train_data_mix20_tensorflow.mat','train_data_mix20','train_label_mix20','train_y_mix20');
...
save('dev_data_mix20_tensorflow.mat','dev_data_mix20','dev_label_mix20','dev_y_mix20');
...
save('test_data_mix20_tensorflow.mat','test_data_mix20','test_label_mix20','test_y_mix20');